...
export const CATEGORY_EMOJIS: Record<(typeof CATEGORIES)[number], string> = {
  fire: '🔥',
  water: '💧',
  earth: '🌍',
  air: '💨',
...
export const CATEGORY_OPTIONS = CATEGORIES.map((cat) => ({
  label: `${CATEGORY_EMOJIS[cat]} ${cat.charAt(0).toUpperCase() + cat.slice(1)}`,
  value: cat,
}));
...
export const INITIAL_CARDS: Card[] = [
  ...
  },
  {
    ...
    title: 'Sky Griffin',
    image:
      'https://images.unsplash.com/photo-1444464666168-49d633b86797?q=80&w=400&auto=format&fit=crop',

...
const cardVariants = cva(
  'group/card flex flex-col overflow-hidden rounded-xl bg-card text-sm text-card-foreground ring-1 ring-foreground/10 transition-all duration-300',
  {
    variants: {
      rarity: {
        default: 'bg-card',
  ...
  return (
    <div
      ...
      className={cn(
        ...
        isFavorite &&
          'ring-2 ring-amber-400 shadow-[0_0_15px_rgba(251,191,36,0.5)] border-amber-400/50'
      )}
      {...props}
    />
  );
